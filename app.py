...
class BotManager:
    ...
    def start(self, message):
        ...
        if len(params) > 1 and params[1] in self.groups:
            ...
            Вы были добавлены в группу '{self.groups[group]}'
            Привет! Я бот Живых Проектов 🤖 \n\n
            Рад видеть тебя на нашем курса "Как создать свое медиа". 
            Мне всегда можно писать с вопросами, а еще я буду присылать напоминания 
            про наши еженедельные вебинары с экспертами курса 🔥
            """)
        else:
